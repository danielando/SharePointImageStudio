...
export default function Pricing() {
  const plans = [
    {
      name: 'Free',
      description: 'Perfect for trying out SharePoint Image Studio',
      price: 0,
      period: '/mo',
      billingNote: '',
      buttonText: 'Get Started Free',
      buttonStyle: 'bg-gray-100 hover:bg-gray-200 text-gray-900',
      limit: '10 images / month',
      features: [
    ...
    {
      name: 'Basic',
      description: 'For regular SharePoint content creators',
      price: 9,
      period: '/mo',
      billingNote: 'billed monthly',
      buttonText: 'Get Basic',
      buttonStyle: 'bg-black hover:bg-gray-800 text-white',
      limit: '100 images / month',
    ...
    },
    {
      ...
      features: [
        'Unlimited variations per generation',
        'Batch image generation',
        'Custom brand elements library',
        'API access',
